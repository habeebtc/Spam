...
<tr class="postheader">
	...
	<td width="80%">
		...
		<tr>
			...
			<td class="extraPoints" align="right">
			<asp:linkbutton runat="server" id="AwardPoints" Text="Rate Post!" AutoPostBack="False"/>  
                <asp:DropDownList id="extraPoints" runat="server" AutoPostBack="False" >
