...
namespace yaf.editor
{
	...
	public class BBCodeEditor : TextEditor
	{
		...
		protected override void Render(HtmlTextWriter writer)
		{
            ...
            RenderButton(writer, "youtube", "FormatText('youtube','')", "Embed Youtube", "yafEditor/youtube.gif");
...
#else
				DB.eventlog_create(null, this.GetType().ToString(), x, yaf.EventLogTypes.Error);
#endif
			}
		}
