...
namespace yaf
{
    ...
    public event EventHandler<yaf.pages.ForumPageArgs> PageTitleSet;
		...
		private void Forum_Load( object sender, EventArgs e )
		{
			...
			try
			{
        pages.ForumPage forumControl = ( pages.ForumPage ) LoadControl( src );
        forumControl.ForumControl = this;
        forumControl.PageTitleSet += new EventHandler<yaf.pages.ForumPageArgs>( forumControl_PageTitleSet );
