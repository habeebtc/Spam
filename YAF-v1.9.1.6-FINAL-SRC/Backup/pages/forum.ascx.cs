...
namespace yaf.pages
{
	...
	public partial class forum : ForumPage
	{
		...
		private void BindData()
		{
			...
			LatestPosts.DataSource = DB.topic_latest( PageBoardID, 5, PageUserID );
		...
		private void UpdateActiveDiscussionsPanel()
		{
			...
			ActiveDiscussionHolder.Visible = ( Mession.PanelState ["ActiveDiscussions"] == PanelSessionState.CollapsiblePanelState.Expanded );
		}
		...
		private void UpdateInformationPanel()
		{
			...
			InformationHolder.Visible = ( Mession.PanelState ["Information"] == PanelSessionState.CollapsiblePanelState.Expanded );
		}
