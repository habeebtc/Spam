...
<tr><td class=post>
	...
	<tr>
		<td class=header2 colspan="2">Step 1 of 5: Configuration setup</td>
	</tr>
	<tr>
		<td colspan="2">
		<p>
...
&lt;/configuration&gt;
	...
	<tr>
		<td class=header2 colspan="2">Step 2 of 5: Connect to database</td>
	</tr>
	<tr>
		<td colspan="2">
		<p>
		    Please verify that you have manually modified the connection string found in
			"<%= Server.MapPath("../yafnet.config") %>" to point to your database.
		</p>
		<p>
	...
	<tr>
		<td class=header2>Step 3 of 5: Initialize database</td>
	</tr>
	<tr>
		<td>
		<p>
	...
	<table width=100% cellspacing=1 cellpadding=0 runat=server visible=false id=stepForum>
		<tr>
			<td colspan="2" class=header2>Step 4 of 5: Create Forum</td>
		</tr>
		<tr>
