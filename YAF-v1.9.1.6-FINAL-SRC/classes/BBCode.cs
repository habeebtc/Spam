	...
	public class BBCode
	{
		...
		static public string MakeHtml( yaf.pages.ForumPage basePage, string bbcode, bool DoFormatting )
		{
			...
			if ( DoFormatting )
			{
				...
				// youtube
                NestedReplace(ref bbcode, r_youtube, @"<!-- BEGIN youtube --><object width=""425"" height=""350""><param name=""movie"" value=""http://www.youtube.com/v/${id}?rel=0&autoplay=0""></param><embed src=""http://www.youtube.com/v/${id}?rel=0&autoplay=0"" type=""application/x-shockwave-flash"" width=""425"" height=""350""></embed></object><br /><a href=""http://youtube.com/watch?v=${id}?rel=0&autoplay=0"" target=""_blank"">${inner}</a><br /><!-- END youtube -->", new string[] { "id" });
