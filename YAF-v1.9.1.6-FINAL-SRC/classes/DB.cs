...
namespace yaf
{
	...
	public class DB
	{
        ...
        /// <summary>
        /// Determines if Post has been rated
        /// </summary>
        /// <returns>Returns bool</returns>
        public static bool hasRated(string UserID, string MessageID)
        {
            return (int)DB.ExecuteScalar(new SqlCommand("SELECT COUNT (*) FROM yaf_Rating WHERE UserID = '" + UserID + "' AND MessageID = '" + MessageID + "'")) > 0;
        }

        public static void RatePost(string UserID, string MessageID, string Rating)
        {
        ...
        {
            return DB.ExecuteScalar(new SqlCommand("SELECT UserID FROM yaf_User WHERE Name = '" + UserName + "'")).ToString();
        }

        public static string GetUserName(string UserID)
        {
            return DB.ExecuteScalar(new SqlCommand("SELECT Name FROM yaf_User WHERE UserID = '" + UserID + "'")).ToString();
        }
		/// <summary>
